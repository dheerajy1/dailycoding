  ...
  return (
    <Layout title={title}>
      <div className="max-w-(--width-health) mx-auto mt-8">
        <h1 className="text-2xl font-bold mb-5 text-(--color-text-primary)">
          Health Status
        </h1>
        ...
        <div className="bg-surface border border-border-thick p-4 md:p-5 rounded-lg">
          <div className="flex justify-between py-2 border-b border-(--color-border)">
            ...
            <span className="font-mono text-text">{response.data.app}</span>
          </div>
          ...
          <div className="flex justify-between items-center py-2">
            <span className="font-semibold text-text-muted min-w-27.5">
              Timestamp
            </span>
